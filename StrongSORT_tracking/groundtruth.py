    ...
    try:
        ...
        for box in preds:
            for r in box.boxes.data.tolist():
                x_min, y_min, x_max, y_max, conf, class_id = r
                #change the class_id to vehicle
                
                # Add the detected object to your annotations
                yolo_writer.addObject('vehicle', timestamp_sec, x_min, y_min, x_max, y_max)
